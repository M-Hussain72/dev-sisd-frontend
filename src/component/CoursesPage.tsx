...
export default function CoursesPage() {
  ...
  const { data, isLoading, isError } = useQuery({
    ...
    queryFn: () => getCoursesByCategory({ categorySlug: categorySlug, filters: selectedFilters }),
  ...
  async function handleGetCourses() {
    return await getCoursesByCategory({ categorySlug: categorySlug, filters: selectedFilters });
  }
