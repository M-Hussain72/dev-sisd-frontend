...
export default function CourseHorizontalCard({ image }: props) {
  return (
    <div className=" w-full items-center flex gap-2 p-4 bg-[#FAFAFA]  rounded-[10px] shadow-md">
      ...
      <div className="px-4 mt-2">
        <div className=" flex justify-between">
          ...
          <p className=" text-[#2B2B2B] text-lg font-semibold ">84.99</p>
        </div>
        <div className="">
          <p className=" text-[#2B2B2B] text-lg font-medium  ">The Complete Python Bootcamp From Zero to Hero in Python</p>
          <p className=" text-themeGray md:block hidden">
            Design web sites and mobile applications that your users love and return to again and again with UX Expert Joe
            Natoli.
          </p>
        </div>
        <div className=" group flex items-center gap-1 my-[10px]  ">
          <svg
            width="20"
            height="20"
            viewBox="0 0 20 20"
          ...
          <p className="  cursor-default text-[#949697]   mt-1 ">Watson Holmes</p>
        </div>
        <div className=" flex text-themeGray">
          <p>32 total hours</p>
          <p>• 23 lectures</p>
          <p>• All Levels</p>
        </div>
