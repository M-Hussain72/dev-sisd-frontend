...
const CourseCard = ({ image }: props) => {
  return (
    <div className="   max-w-[255px] rounded-[10px] shadow-md">
      <div className="  overflow-hidden rounded-t-[10px] ">
        <img
          src={image ? image : sampleImage}
          className=" xs:min-h-[170px] min-h-[130px] hover:scale-125 transition-all duration-500 cursor-pointer"
        />
      </div>
      <div className="px-4 mt-6">
        <div className="flex">
          ...
          />
          {/* no of reviews */}
          <span className=" ml-1 text-xs text-[#949697] cursor-default">
            (3203400)
          </span>
        </div>
        <div className=" group flex items-center gap-1 xs:my-3 my-2">
          <svg
            width="20"
            height="20"
            viewBox="0 0 20 20"
          ...
          <p className="  cursor-default text-[#949697] xs:text-sm text-xs mt-1 ">
            Watson Holmes
          </p>
        </div>
        <div className=" mb-4 pb-2">
          <p className=" text-[#2B2B2B] xs:text-lg w-[90%] text-sm ">
