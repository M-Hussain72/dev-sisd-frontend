  ...
  return (
    <div className="max-w-[1091px] flex-1">
      <div className="flex justify-between mb-8 text-[24px] w-full font-semibold text-themeBlack">
        <div className=" flex gap-2">
          ...
          <div className="mb-4 min-[1050px]:hidden">
            <button
              className=" hover:bg-blue-300 bg-[#E9ECEF] border-[1px] py-2 px-1 rounded"
              onClick={() => setDrawerOpened(true)}
            >
              <svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="24" height="18" viewBox="0 0 256 256">
                <g
      ...
      {data && data.courses?.length > 0 ? (
        ...
        <div>
          <div className="max-w-[1091px]  flex items-center justify-center sm:px-24 px-14">
