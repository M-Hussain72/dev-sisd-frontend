  ...
  return (
    <div className=" my-20 ">
      ...
      <div className=" mt-10  grid lg:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-6">
        <DiverseCrsCard icon={Icon.pen} bgIconColor={'#307EE124'} title="Design & Development" noOfCourses={25} />
        <DiverseCrsCard icon={Icon.loudSpeaker} bgIconColor={'#EC732F1A'} title="Digital Marketing" noOfCourses={3005} />
        <DiverseCrsCard icon={Icon.graph} bgIconColor={'#9747FF1A'} title="Business & Consulting" noOfCourses={250} />
