...
const HeroSection = () => {
  return (
    <div className=" min-[845px]:flex  gap-8 mt-20 xs:mx-16 mx-8 justify-between">
      <div className=" md:w-[546px] w-full xs:mt-16 mt-6 ">
        ...
        <p className=" xs:mt-8 mt-4 xs:text-lg text-sm text-[#949697] font-normal">
          Let’s take on online course to improve your skills in a different and
          set your own study time according to your learning speed with the best
          teaching instructors in the world!
        </p>
        <div className=" mt-6">
      ...
      <div className=" relative w-fit h-fit ">
        <div className=" -z-10 absolute -right-[20px] sm:-right-[50px] -top-5 w-[120px] h-[120px]  sm:w-[200px] sm:h-[200px] rounded-full bg-[#FFD05A]"></div>
        <div className=" -z-10 absolute right-[55%] -top-5  w-[20px] h-[20px] rounded-full bg-[#FFD05A]"></div>
        ...
        <div className=" max-w-[556px] min-[845px]:max-w-[256px] lg:max-w-[556px]   w-full   mt-8 gap-4 grid grid-cols-2 min-[845px]:grid-rows-2 min-[845px]:grid-cols-none lg:grid-cols-2 ">
          <img
            src={asianWomen}
            className=" lg:block min-[845px]:hidden block"
          />
          <img src={blueMen} />
