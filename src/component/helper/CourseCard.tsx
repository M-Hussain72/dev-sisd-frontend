        ...
        {!isPaid ? (
          ...
          <div>
            ...
            {percentageComplete && percentageComplete > 0 ? (
              <div className="mt-2 mb-4 flex gap-2 justify-between">
                <p className=" text-themeGray6  ">{percentageComplete === 100 ? '' : percentageComplete + '% '} Completed</p>
                {/* { percentageComplete > 50 &&<p className=" text-themeBlue font-medium  ">Leave a Rating</p>} */}
              </div>
            ) : (
